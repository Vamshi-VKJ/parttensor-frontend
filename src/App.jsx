...
// IMPORTANT: Replace below with your real Supabase anon key from Supabase -> Settings -> API
...
// UPGRADE MODAL
// =============================================
function UpgradeModal({ onClose, onSignIn, onPay, defaultBilling }) {
  var [billing, setBilling] = useState(defaultBilling || "monthly");
  var prices = {
